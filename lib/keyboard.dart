...
class _KiyibodiState extends State<Kiyibodi> {
  ...
  void onTap(KeyboardInputType keyboardInputType) {
    widget.keyboardController.handleActionByKeyboardInputType(keyboardInputType);
  }

  void _onLongPress() {
    widget.keyboardController.handleActionByKeyboardInputType(KeyboardInputType.longDelete);
  }
